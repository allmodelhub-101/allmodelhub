...
export function MarketingNav() {
  return <nav className="marketing-nav"><div className="container marketing-nav-inner">
    <Brand />
    <div className="nav-links" aria-label="Primary navigation"><a href="#models">Models</a><a href="#create">Create</a><a href="#credits">Credits</a><a href="#pakistan">Pakistan</a><a href="#faq">FAQ</a></div>
